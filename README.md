...
When I was creating this list, I putted on it only things that I had read by myself. If you know book or a course or YouTube channel which is great, and somebody will surely enjoy learning from it - feel free to open issue/msg me - i will acquaint with it and (if it wont be bad) add this to the list. Also feel free to share it on groups, with friends etc.
